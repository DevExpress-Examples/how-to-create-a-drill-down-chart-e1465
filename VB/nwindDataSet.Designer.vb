...
Namespace nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As nwindDataSet.SalesPersonDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As nwindDataSet.SalesPersonDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
